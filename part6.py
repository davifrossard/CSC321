...
plt.savetxt("results/part 6/eval_performance.csv", np.array(zip(best_k, best_perf)), fmt='%i %i')
...
plt.savetxt("results/part 6/eval_performance.csv", np.array(zip(best_k_t, best_perf)), fmt='%i %i')
